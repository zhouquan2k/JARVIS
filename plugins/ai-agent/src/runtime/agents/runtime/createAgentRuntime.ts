...
import type { IModelProvider, ProviderSendResult, ProviderStreamUpdate, MessageFunctionalPart, ModelProviderRuntime } from '@plugins/ai-agent/src/internal';
...
export function createAgentRuntime(options: CreateAgentRuntimeOptions): AgentRuntime {
    const maxToolIterations = options.maxToolIterations ?? 9;
            ...
            try {
                ...
                const result = await provider.sendMessage(
                    preparedRequest.prompt,
                    {
                        ...
                        groupMemberSessions: request.groupMemberSessions
                    },
                    onUpdate
                );
                return {
